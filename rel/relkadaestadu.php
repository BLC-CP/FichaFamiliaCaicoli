...
<div id="div1">
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("select * FROM tb_estadu_civil where id_estadu_civil like '$id_estadu_civil' LIMIT 1");
			while($r=$a->fetch_array()){
				...
				<tr>
					...
					<td>
						Dadus husi naran <b><?php echo $r['nrn_estadu_civil']; ?></b> nian.
					</td>
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("SELECT * FROM tb_populasaun, tb_aldeia, tb_profisaun, tb_literaria, tb_religiaun, tb_estadu_civil WHERE 
				...
				tb_populasaun.id_estadu_civil=tb_estadu_civil.id_estadu_civil AND tb_estadu_civil.id_estadu_civil LIKE '$id_estadu_civil'
				");	
