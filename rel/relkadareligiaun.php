...
<div id="div1">
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("select * FROM tb_religiaun where id_religiaun like '$id_religiaun' LIMIT 1");
			while($r=$a->fetch_array()){
				...
				<tr>
					...
					<td>
						Dadus husi naran <b><?php echo $r['nrn_religiaun']; ?></b> nian.
					</td>
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("SELECT * FROM tb_populasaun, tb_aldeia, tb_profisaun, tb_literaria, tb_religiaun, tb_estadu_civil WHERE 
				...
				tb_populasaun.id_estadu_civil=tb_estadu_civil.id_estadu_civil AND tb_religiaun.id_religiaun LIKE '$id_religiaun'
				");	
